...
function GreenTipPage() {
  ...
  const fetchTips = async (category = "") => {
    ...
    setError("")
    try {
      const endpoint = category ? `/tips/category?category=${category}` : "/tips"
  ...
  const handleCreateTip = async (e) => {
    ...
    try {
      ...
      setFormData({ title: "", description: "", category: "CAR", co2SavedEstimate: "" })
      setShowForm(false)
  ...
  return (
    <div className="container mt-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        >
          {showForm ? "Annulla" : "+ Nuovo consiglio"}
        </button>
      </div>
      ...
      {showForm && (
        <div className="card shadow-sm mb-4">
          <div className="card-body">
            <h6 className="fw-bold mb-3">Nuovo consiglio verde</h6>
            ...
            <form onSubmit={handleCreateTip}>
              ...
              <div className="mb-3">
                <label className="form-label">Stima CO₂ risparmiata (kg)</label>
                <input
                  type="number"
            ...
            <div key={tip.id} className="col-md-6 col-lg-4">
              <div className="card shadow-sm h-100">
                <div className="card-body">
                  ...
                  <p className="text-muted small mb-2">{tip.description}</p>

                  {/* Stima CO₂ risparmiata */}
